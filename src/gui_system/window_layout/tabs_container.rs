use rwge::{
    color::{HSLA, RGBA},
    glam::{vec2, Vec2},
    gui::rect_ui::{element::builder::ElementBuilder, event::UIEvent, BorderRadius, RectMask},
    math_utils::lerp_f32,
    slotmap::slotmap::Slotmap,
};

use crate::{
    gui_system::{control::ControlState, gui_container::GUIContainer, ContainerInfo},
        ...
        match event {
            UIEvent::Render { gui_rects, .. } => {
                ...
                for index in 0..self.tabs.len() {
                    ...
                    let (round_rect, color) = if index == self.active_tab {
                        ...
                        (
                            BorderRadius::ForTopBottom {
                                top: tab_menu_size.y * 0.5 - TAB_GAP,
                                bottom: 0.0,
                            },
                            RGBA::rrr1(0.55),
                        )
                    ...
                    ElementBuilder::new(tab_btn_pos, tab_btn_size)
